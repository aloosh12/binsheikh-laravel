function initRenstate() {
    ...
    //     networks: ['facebook', 'pinterest', 'tumblr', 'twitter', 'instagram']
    // });
    //   Video------------------	
    ...
    $window.scroll(function () {
        ...
        if ($(this).scrollTop() > 150) {
            $("header.header_half , .header-sticky").addClass("scroll-sticky");
        } else {
            $("header.header_half , .header-sticky").removeClass("scroll-sticky");
        }
    });
